      ...
      <Flex bgColor='whiteAlpha.800' boxShadow='lg' h='xl' borderRadius={20} direction='column' p={8} gap={2} >
        ...
        <Code textColor='gray.900' borderRadius={10} alignSelf='center' px={8}>
          <Text fontSize='md' textAlign='justify'>
            I&apos;m a self taught <Text as='span' fontWeight='extrabold'>front-end</Text> software engineer who has a natural fascination for problem solving and technology. Along side my skills as a software developer, I also have a Bachelors Degree in Business Management and Marketing - not only do I provide skills as a developer, but as a well rounded businessman too.<br /><br /> I love to develop myself, help others, and build long lasting relationships. My work philosophy is to consistently learn with an open mind - getting me one step closer to perfecting my craft.
          </Text>
        </Code>
